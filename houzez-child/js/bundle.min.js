...
window.cash = function() {
    var n, s = document, a = window, e = Array.prototype, r = e.slice, i = e.filter, o = e.push, t = function() {}, u = function(e) {
    ...
    function f(e, t) {
        t = t || s;
        var n = h.test(e) ? t.getElementsByClassName(e.slice(1)) : p.test(e) ? t.getElementsByTagName(e) : t.querySelectorAll(e);
        return n
    }
    function v(e) {
        if (!n) {
            var t = (n = s.implementation.createHTMLDocument(null)).createElement("base");
            t.href = s.location.href,
    ...
    function y(e, t) {
        ...
        var n, i = e, o = 0;
        if (c(e))
            i = l.test(e) ? s.getElementById(e.slice(1)) : d.test(e) ? v(e) : f(e, t);
        else if (u(e))
            return m(e),
            this;
        if (!i)
        ...
        if (i.nodeType || i === a)
            ...
            for (n = this.length = i.length; o < n; o++)
                this[o] = i[o];
        return this
    }
    function g(e, t) {
    ...
    var _ = g.fn = g.prototype = y.prototype = {
        cash: !0,
        length: 0,
        push: o,
        splice: e.splice,
    ...
    function C(e) {
        return g(r.call(e).filter(function(e, t, n) {
    ...
    function T(e, t) {
        var n = E(e);
        return void 0 === n[t] && (n[t] = e.dataset ? e.dataset[t] : g(e).attr("data-" + t)),
        n[t]
    }
    _.extend({
        data: function(t, n) {
            if (c(t))
                return void 0 === n ? T(this[0], t) : this.each(function(e) {
                    return M(e, t, n)
                });
            for (var e in t)
                this.data(e, t[e]);
        ...
        removeData: function(o) {
            return this.each(function(e) {
                return n = o,
                void ((i = E(t = e)) ? delete i[n] : t.dataset ? delete t.dataset[n] : g(t).removeAttr("data-" + name));
                var t, n, i
            })
        }
    });
    ...
    _.extend({
        ...
        attr: function(t, n) {
            if (t) {
                if (c(t))
                    return void 0 === n ? this[0] ? this[0].getAttribute ? this[0].getAttribute(t) : this[0][t] : void 0 : this.each(function(e) {
    ...
    _.extend({
        ...
        filter: function(t) {
            if (!t)
                return this;
            var n = u(t) ? t : k(t);
            return g(i.call(this, function(e) {
                return n(e, t)
            }))
        },
        first: function() {
        ...
        index: function(e) {
            var t = e ? g(e)[0] : this[0]
              , n = e ? this : g(t).parent().children();
            return r.call(n).indexOf(t)
        },
        last: function() {
            return this.eq(-1)
        }
    });
    var R, $, j, A, I, P, H = (I = /(?:^\w|[A-Z]|\b\w)/g,
    P = /[\s-_]+/g,
    function(e) {
    ...
    function(t) {
        ...
        var e = t.charAt(0).toUpperCase() + t.slice(1)
          , n = (t + " " + ["webkit", "moz", "ms", "o"].join(e + " ") + e).split(" ");
    ...
    function N(e, t) {
        return parseInt(a.getComputedStyle(e[0], null)[t], 10) || 0
    }
    function W(t, n, e) {
        var i, o = T(t, "_cashEvents"), s = o && o[n];
        s && (e ? (t.removeEventListener(n, e),
        0 <= (i = s.indexOf(e)) && s.splice(i, 1)) : (b(s, function(e) {
    ...
    _.extend({
        css: function(t, n) {
            if (c(t))
                return t = F(t),
                1 < arguments.length ? this.each(function(e) {
                    return e.style[t] = n
                }) : a.getComputedStyle(this[0])[t];
            for (var e in t)
                this.css(e, t[e]);
            return this
        }
    ...
    b(["Width", "Height"], function(t) {
        ...
        _["outer" + t] = function(e) {
            return this[0]["offset" + t] + (e ? N(this, "margin" + ("Width" === t ? "Left" : "Top")) + N(this, "margin" + ("Width" === t ? "Right" : "Bottom")) : 0)
        }
    }),
    _.extend({
        off: function(t, n) {
        ...
        on: function(a, n, r, l) {
            ...
            if (c(a))
                ...
                this.each(function(e) {
                    ...
                    n = a,
                    i = s,
                    (o = T(t = e, "_cashEvents") || M(t, "_cashEvents", {}))[n] = o[n] || [],
                    o[n].push(i),
    ...
    _.extend({
        ...
        val: function(t) {
            return void 0 === t ? V(this[0]) : this.each(function(e) {
                return e.value = t
            })
        }
    }),
    _.extend({
        ...
        before: function(e) {
            return g(e).insertBefore(this),
            this
        },
        clone: function() {
            return g(this.map(function(e) {
    ...
    return _.extend({
        ...
        offset: function() {
            ...
            return {
                top: e.top + a.pageYOffset - Y.clientTop,
                left: e.left + a.pageXOffset - Y.clientLeft
            }
        },
    ...
    _.extend({
        ...
        closest: function(e) {
            return !e || this.length < 1 ? g() : this.is(e) ? this.filter(e) : this.parent().closest(e)
        },
        is: function(t) {
            if (!t)
                return !1;
        ...
        find: function(t) {
            if (!t || t.nodeType)
                return g(t && this.has(t).length ? t : null);
            var n = [];
            return this.each(function(e) {
                o.apply(n, f(t, e))
            }),
        ...
        parents: function(t) {
            var n, i = [];
            return this.each(function(e) {
                for (n = e; n && n.parentNode && n !== s.body.parentNode; )
                    n = n.parentNode,
                    (!t || t && w(n, t)) && i.push(n)
            }),
            C(i)
...
var Component = function() {
    function o(e, t, n) {
        ...
        t instanceof Element || console.error(Error(t + " is not an HTML Element"));
...
M.initializeJqueryWrapper = function(i, o, s) {
    jQuery.fn[o] = function(t) {
        if (i.prototype[t]) {
            ...
            var e = this.first()[0][s];
            return e[t].apply(e, n)
        }
        if ("object" == typeof t || !t)
            return i.init(this, t),
            this;
...
M.checkWithinContainer = function(e, t, n) {
    ...
    (u + t.height > s - n || u + t.height > window.innerHeight - n) && (i.bottom = !0),
    i
}
,
...
M.throttle = function(n, i, o) {
    ...
    return function() {
        ...
        u = e,
        r = n.apply(s, a),
        s = a = null) : l || !1 === o.trailing || (l = setTimeout(c, t)),
        r
    }
}
;
...
M.anime = function() {
    ...
    function w(e, t) {
        for (var n = e.length, i = 2 <= arguments.length ? t : void 0, o = [], s = 0; s < n; s++)
            if (s in e) {
                var a = e[s];
    ...
    function c(e) {
        return e.reduce(function(e, t) {
            return e.concat(S.arr(t) ? c(t) : t)
        }, [])
    }
    function s(e) {
        return S.arr(e) ? e : (S.str(e) && (e = o(e) || e),
    ...
    function f(e, t) {
        return S.dom(e) && a(B, t) ? "transform" : S.dom(e) && (e.getAttribute(t) || S.svg(e) && e[t]) ? "attribute" : S.dom(e) && "transform" !== t && k(e, t) ? "css" : null != e[t] ? "object" : void 0
    }
    function v(e, t) {
        switch (f(e, t)) {
        case "transform":
            return function(e, n) {
                ...
                if (!(e = e.style.transform))
                    return t;
                for (var i = [], o = [], s = [], a = /(\w+)\((.+?)\)/g; i = a.exec(e); )
                    o.push(i[1]),
                    s.push(i[2]);
    ...
    function g(e) {
        ...
        case "polygon":
            var t = e.points;
            return n(e) + y(t.getItem(t.numberOfItems - 1), t.getItem(0))
        }
    }
    function C(t, n) {
        function e(e) {
    ...
    function _(e, t) {
        var n, i = /-?\d*\.?\d+/g;
        if (n = S.pth(e) ? e.totalLength : e,
        S.col(n))
            if (S.rgb(n)) {
                var o = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(n);
                n = o ? "rgba(" + o[1] + ",1)" : n
            } else
                n = S.hex(n) ? function(e) {
    ...
    function b(e) {
        return w(e = e ? c(S.arr(e) ? e.map(s) : s(e)) : [], function(e, t, n) {
            return n.indexOf(e) === t
        })
    }
    function O(e, n) {
        ...
        if (S.arr(e)) {
            var i = e.length;
            2 !== i || S.obj(e[0]) ? S.fnc(n.duration) || (t.duration = n.duration / i) : e = {
                value: e
            }
        }
    ...
    function i(e) {
        var t, n, i, o, s = h(L, e), a = h(x, e), r = (n = e.targets,
        (i = b(n)).map(function(e, t) {
            return {
                target: e,
                id: t,
                total: i.length
        ...
        for (t in e)
            u.hasOwnProperty(t) || "targets" === t || l.push({
                name: t,
                offset: u.offset,
                tweens: O(e[t], a)
            });
        return o = l,
        e = w(c(r.map(function(i) {
            return o.map(function(e) {
                var t = f(i.target, e.name);
                if (t) {
                    var n = E(e, i);
                    e = {
                        type: t,
    ...
    function T(e) {
        ...
        function d(t) {
            for (var e = 0, n = {}, i = b.animations, o = i.length; e < o; ) {
                var s = i[e]
                  , a = s.animatable
                  , r = s.tweens
                  , l = r.length - 1
                ...
                for (var r = Math.min(Math.max(t - u.start - u.delay, 0), u.duration) / u.duration, c = isNaN(r) ? 1 : u.easing(r, u.elasticity), r = u.to.strings, h = u.round, l = [], d = void 0, d = u.to.numbers.length, p = 0; p < d; p++) {
                    var f = void 0
                      , f = u.to.numbers[p]
                      , v = u.from.numbers[p]
                      , f = u.isPath ? C(u.value, c * f) : v + c * (f - v);
                    h && (u.isColor && 2 < p || (f = Math.round(f * h) / h)),
                    l.push(f)
                }
                if (u = r.length)
                    for (d = r[0],
                    c = 0; c < u; c++)
                        h = r[c + 1],
                        p = l[c],
                        isNaN(p) || (d = h ? d + (p + h) : d + (p + " "));
                else
                    d = l[0];
                j[s.type](a.target, s.property, d, n, a.id),
                s.currentValue = d,
                e++
            }
            if (e = Object.keys(n).length)
                for (i = 0; i < e; i++)
                    D || (D = k(document.body, "transform") ? "transform" : "-webkit-transform"),
                    b.animatables[i].target.style[D] = n[i].join(" ");
            b.currentTime = t,
            b.progress = t / b.duration * 100
        }
        function p(e) {
            b[e] && b[e](b)
        }
        ...
        function t(e) {
            ...
            (i <= a || !t) && (b.began || (b.began = !0,
            p("begin")),
            p("run")),
            n < a && a < t ? d(a) : (a <= n && 0 !== o && (d(0),
            s && f()),
            (t <= a && o !== t || !t) && (d(t),
            s || f())),
            p("update"),
            t <= e && (b.remaining ? (m = v,
            "alternate" === b.direction && (b.reversed = !b.reversed)) : (b.pause(),
        ...
        return b.reset = function() {
            ...
            b.remaining = "alternate" === e && 1 === t ? 2 : t,
            d(0),
            e = b.children.length; e--; )
                b.children[e].reset()
        }
        ,
        b.tick = function(e) {
    ...
    var D, L = {
        ...
        elasticity: 500,
        round: 0
    }, B = "translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY perspective".split(" "), S = {
        arr: function(e) {
            ...
            if (0 <= a && a <= 1 && 0 <= l && l <= 1) {
                ...
                return function(e) {
                    ...
                    var n = t + (e - c[--n]) / (c[n + 1] - c[n]) * .1
                      , i = 3 * (1 - 3 * l + 3 * a) * n * n + 2 * (3 * l - 6 * a) * n + 3 * a;
                    if (.001 <= i) {
                        for (t = 0; t < 4 && 0 != (i = 3 * (1 - 3 * l + 3 * a) * n * n + 2 * (3 * l - 6 * a) * n + 3 * a); ++t)
                            var o = h(n, a, l) - e
                              , n = n - o / i;
                        e = n
                    } else if (0 === i)
                        ...
                        for (var n = t, t = t + .1, s = 0; 0 < (i = h(o = n + (t - n) / 2, a, l) - e) ? t = o : n = o,
        ...
        var e, i = "Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "), t = {
        ...
        for (e in t)
            s.type = e,
            t[s.type].forEach(function(n) {
                return function(e, t) {
                    o["ease" + n.type + i[t]] = S.fnc(e) ? e : R.apply($jscomp$this, e)
                }
            }(s)),
            s = {
                type: s.type
    ...
    T.remove = function(e) {
        ...
        for (var t = A.length; t--; )
            for (var n = A[t], i = n.animations, o = i.length; o--; )
                a(e, i[o].animatable.target) && (i.splice(o, 1),
                i.length || n.pause())
    }
    ,
    T.getValue = v,
    T.path = function(e, t) {
        var n = S.str(e) ? o(e)[0] : e
          , i = t || 100;
        return function(e) {
            return {
                el: n,
                property: e,
                totalLength: g(n) * (i / 100)
            }
        }
    }
    ,
    ...
    T.timeline = function(i) {
        ...
        o.add = function(e) {
            ...
            s(e).forEach(function(e) {
                ...
                t.offset = S.und(n) ? e : m(n, e),
                o.began = !0,
                o.completed = !0,
                o.seek(t.offset),
                (t = T(t)).began = !0,
                t.completed = !0,
                t.duration > e && (o.duration = t.duration),
                o.children.push(t)
            }),
            o.seek(0),
            o.reset(),
...
!function(u, n) {
    ...
    var t = {
      ...
      , e = function(e) {
        function i(e, t) {
            ...
            n.$dropdownEl = u(n.dropdownEl),
            n.options = u.extend({}, i.defaults, t),
            n.isOpen = !1,
            n.isScrollable = !1,
            n.isTouchMoving = !1,
            n.focusedIndex = -1,
            n.filterQuery = [],
            n.options.container ? u(n.options.container).append(n.dropdownEl) : n.$el.after(n.dropdownEl),
        ...
        _createClass(i, [{
            ...
            value: function(e) {
                ...
                o.length && o[0].M_Dropdown && o[0].M_Dropdown.isOpen && (i = !0),
                i || n || this.close()
            }
        }, {
            ...
            value: function(e) {
                if (e.which === M.keys.TAB)
                    ...
                    } while (o < this.dropdownEl.children.length && 0 <= o);s && (this.focusedIndex = o,
            ...
            value: function() {
                ...
                u(this.dropdownEl).children().each(function(e) {
            ...
            value: function() {
                ...
                if (s += this.options.coverTrigger ? 0 : e.height,
                this.isScrollable = !1,
    ...
    e._dropdowns = [],
    M.Dropdown = e,
    M.jQueryLoaded && M.initializeJqueryWrapper(e, "dropdown", "M_Dropdown")
}(cash, M.anime);
_createClass = function() {
    function i(e, t) {
        for (var n = 0; n < t.length; n++) {
    ...
    var t = {
      ...
      , e = function(e) {
        function i(e, t) {
            _classCallCheck(this, i);
            var n = _possibleConstructorReturn(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, i, e, t));
            return (n.el.M_Modal = n).options = o.extend({}, i.defaults, t),
            n.isOpen = !1,
            n.id = n.$el.attr("id"),
            n._openingTrigger = void 0,
            n.$overlay = o('<div class="modal-overlay"></div>'),
            n.el.tabIndex = 0,
            n._nthModalOpened = 0,
            i._count++,
            n._setupEventHandlers(),
    ...
    var t = {
      ...
      , e = function(e) {
        function i(e, t) {
            _classCallCheck(this, i);
            var n = _possibleConstructorReturn(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, i, e, t));
            return (n.el.M_Tabs = n).options = a.extend({}, i.defaults, t),
        ...
        _createClass(i, [{
            ...
            value: function(e) {
                var t = this
                  , n = a(e.target).closest("li.tab")
                  , i = a(e.target).closest("a");
                if (i.length && i.parent().hasClass("tab"))
                    if (n.hasClass("disabled"))
                        ...
                        var o = this.$content;
                        this.$activeTabLink = i,
                        this.$content = a(M.escapeHash(i[0].hash)),
                        this.$tabLinks = this.$el.children("li.tab").children("a"),
                        this.$activeTabLink.addClass("active");
                        var s = this.index;
                        this.index = Math.max(this.$tabLinks.index(i), 0),
            ...
            value: function() {
                ...
                this.$tabLinks.each(function(e) {
                    var t = a(M.escapeHash(e.hash));
                    t.addClass("carousel-item"),
                    i = i.add(t)
                });
                var e = a('<div class="tabs-content carousel carousel-slider"></div>');
                i.first().before(e),
                e.append(i),
                i[0].style.display = "";
                ...
                this._tabsCarousel = M.Carousel.init(e[0], {
                    ...
                    onCycleTo: function(e) {
                        var t = n.index;
                        n.index = a(e).index(),
                        n.$activeTabLink.removeClass("active"),
                        n.$activeTabLink = n.$tabLinks.eq(n.index),
                        n.$activeTabLink.addClass("active"),
                        n._animateIndicator(t),
...
function(n) {
    ...
    var y = {
        ...
        show: function(e, t) {
            ...
            n.appendChild(i);
            var o, s, a, r, l, u, c, h = (u = {
                top: 0,
                left: 0
            },
            c = (o = n) && o.ownerDocument,
            s = c.documentElement,
            void 0 !== o.getBoundingClientRect && (u = o.getBoundingClientRect()),
            a = null !== (l = r = c) && l === l.window ? r : 9 === r.nodeType && r.defaultView,
            {
                top: u.top + a.pageYOffset - s.clientTop,
                left: u.left + a.pageXOffset - s.clientLeft
            }), d = e.pageY - h.top, p = e.pageX - h.left, f = "scale(" + n.clientWidth / 100 * 10 + ")";
            "touches"in e && (d = e.touches[0].pageY - h.top,
            p = e.touches[0].pageX - h.left),
            i.setAttribute("data-hold", Date.now()),
            i.setAttribute("data-scale", f),
            i.setAttribute("data-x", p),
            i.setAttribute("data-y", d);
            var v = {
                top: d + "px",
                left: p + "px"
            };
            i.className = i.className + " waves-notransition",
            i.setAttribute("style", m(v)),
            ...
            v.transform = f,
            v.opacity = "1",
            v["-webkit-transition-duration"] = y.duration + "ms",
            v["-moz-transition-duration"] = y.duration + "ms",
            v["-o-transition-duration"] = y.duration + "ms",
            v["transition-duration"] = y.duration + "ms",
        ...
        hide: function(e) {
            ...
            setTimeout(function() {
                var e = {
                    ...
                    left: o + "px",
                    opacity: "0",
                    "-webkit-transition-duration": y.duration + "ms",
                    "-moz-transition-duration": y.duration + "ms",
                    "-o-transition-duration": y.duration + "ms",
                    "transition-duration": y.duration + "ms",
                    "-webkit-transform": a,
                    "-moz-transform": a,
                    "-ms-transform": a,
                    "-o-transform": a,
      ...
      , l = {
        ...
        allowEvent: function(e) {
            ...
            }, 500) : "mousedown" === e.type && 0 < l.touches && (t = !1),
            t
        },
        touchup: function(e) {
            l.allowEvent(e)
    ...
    function i(e) {
        ...
        null !== t && (y.show(e, t),
        "ontouchstart"in n && (t.addEventListener("touchend", y.hide, !1),
        t.addEventListener("touchcancel", y.hide, !1)),
        t.addEventListener("mouseup", y.hide, !1),
        t.addEventListener("mouseleave", y.hide, !1),
        t.addEventListener("dragend", y.hide, !1))
    }
    e.displayEffect = function(e) {
        "duration"in (e = e || {}) && (y.duration = e.duration),
        y.wrapInput(t(".waves-effect")),
        "ontouchstart"in n && document.body.addEventListener("touchstart", i, !1),
        document.body.addEventListener("mousedown", i, !1)
    }
    ,
    e.attach = function(e) {
        "input" === e.tagName.toLowerCase() && (y.wrapInput([e]),
        e = e.parentNode),
        "ontouchstart"in n && e.addEventListener("touchstart", i, !1),
    ...
    var t = {
      ...
      , e = function(e) {
        function i(e, t) {
            _classCallCheck(this, i);
            var n = _possibleConstructorReturn(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, i, e, t));
            return (n.el.M_Sidenav = n).id = n.$el.attr("id"),
            n.options = o.extend({}, i.defaults, t),
            n.isOpen = !1,
        ...
        _createClass(i, [{
            ...
            value: function() {
                ...
                this.isDragged && (t = "left" === this.options.edge ? t + this.percentOpen : t - this.percentOpen),
                s.remove(this.el),
                s({
                    targets: this.el,
                    translateX: [100 * t + "%", 0],
            ...
            value: function() {
                var e = this
                  , t = "left" === this.options.edge ? -1 : 1
                  , n = 0;
                this.isDragged && (n = "left" === this.options.edge ? t + this.percentOpen : t - this.percentOpen),
                s.remove(this.el),
                s({
                    targets: this.el,
...
function(c) {
    M.updateTextFields = function() {
        c("input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], input[type=date], input[type=time], textarea").each(function(e, t) {
            var n = c(this);
            0 < e.value.length || c(e).is(":focus") || e.autofocus || null !== n.attr("placeholder") ? n.siblings("label").addClass("active") : e.validity ? n.siblings("label").toggleClass("active", !0 === e.validity.badInput) : n.siblings("label").removeClass("active")
        })
    }
    ,
    ...
    M.textareaAutoResize = function(e) {
        if (e instanceof Element && (e = c(e)),
        e.length) {
            var t = c(".hiddendiv").first();
            t.length || (t = c('<div class="hiddendiv common"></div>'),
            c("body").append(t));
            ...
            i && t.css("font-size", i),
            n && t.css("font-family", n),
            o && t.css("line-height", o),
            s && t.css("padding-top", s),
            a && t.css("padding-right", a),
            r && t.css("padding-bottom", r),
            l && t.css("padding-left", l),
            ...
            t.html(u),
            0 < e[0].offsetWidth && 0 < e[0].offsetHeight ? t.css("width", e.width() + "px") : t.css("width", window.innerWidth / 2 + "px"),
            e.data("original-height") <= t.innerHeight() ? e.css("height", t.innerHeight() + "px") : e[0].value.length < e.data("previous-length") && e.css("height", e.data("original-height") + "px"),
    ...
    c(document).ready(function() {
        ...
        c(document).on("change", i, function() {
            0 === this.value.length && null === c(this).attr("placeholder") || c(this).siblings("label").addClass("active"),
            M.validate_field(c(this))
        }),
        c(document).ready(function() {
            M.updateTextFields()
        }),
        c(document).on("reset", function(e) {
            var t = c(e.target);
            t.is("form") && (t.find(i).removeClass("valid").removeClass("invalid"),
            t.find(i).each(function(e) {
        ...
        document.addEventListener("focus", function(e) {
            c(e.target).is(i) && c(e.target).siblings("label, .prefix").addClass("active")
        }, !0),
        document.addEventListener("blur", function(e) {
            var t = c(e.target);
            if (t.is(i)) {
                var n = ".prefix";
                0 === t[0].value.length && !0 !== t[0].validity.badInput && null === t.attr("placeholder") && (n += ", label"),
                t.siblings(n).removeClass("active"),
                M.validate_field(t)
            }
        }, !0);
        c(document).on("keyup", "input[type=radio], input[type=checkbox]", function(e) {
            if (e.which === M.keys.TAB)
                return c(this).addClass("tabbed"),
                void c(this).one("blur", function(e) {
        ...
        c(document).on("change", '.file-field input[type="file"]', function() {
            for (var e = c(this).closest(".file-field").find("input.file-path"), t = c(this)[0].files, n = [], i = 0; i < t.length; i++)
                n.push(t[i].name);
            e[0].value = n.join(", "),
            e.trigger("change")
        })
...
!function(r, o) {
    ...
    var e = function(e) {
        function i(e, t) {
            _classCallCheck(this, i);
            var n = _possibleConstructorReturn(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, i, e, t));
            return (n.el.M_FloatingActionButton = n).options = r.extend({}, i.defaults, t),
            n.isOpen = !1,
        ...
        _createClass(i, [{
            ...
            value: function() {
                var e, t = this, n = window.innerWidth, i = window.innerHeight, o = this.el.getBoundingClientRect(), s = r('<div class="fab-backdrop"></div>'), a = this.$anchor.css("background-color");
                this.$anchor.append(s),
                this.offsetX = o.left - n / 2 + o.width / 2,
                this.offsetY = i - o.bottom,
                e = n / s[0].clientWidth,
    ...
    var t = {
      ...
      , e = function(e) {
        function B(e, t) {
            ...
            var n = _possibleConstructorReturn(this, (B.__proto__ || Object.getPrototypeOf(B)).call(this, B, e, t));
            (n.el.M_Datepicker = n).options = y.extend({}, B.defaults, t),
            t && t.hasOwnProperty("i18n") && "object" == typeof t.i18n && (n.options.i18n = y.extend({}, B.defaults.i18n, t.i18n)),
            n.options.minDate && n.options.minDate.setHours(0, 0, 0, 0),
            n.options.maxDate && n.options.maxDate.setHours(0, 0, 0, 0),
            n.id = M.guid(),
            n._setupVariables(),
            n._insertHTMLIntoDOM(),
            n._setupModal(),
            n._setupEventHandlers(),
            n.options.defaultDate || (n.options.defaultDate = new Date(Date.parse(n.el.value)));
            var i = n.options.defaultDate;
            return B._isDate(i) ? n.options.setDefaultDate ? (n.setDate(i, !0),
            n.setInputValue()) : n.gotoDate(i) : n.gotoDate(new Date),
            n.isOpen = !1,
            n
        }
        ...
        _createClass(B, [{
            ...
            value: function() {
                this.options.showClearBtn && (y(this.clearBtn).css({
                    visibility: ""
                }),
            ...
            value: function(e) {
                ...
                B._isDate(this.date) ? e.split(/(d{1,4}|m{1,4}|y{4}|yy|!.)/g).map(function(e) {
            ...
            value: function(e, t) {
                ...
                B._isDate(e)) {
                    ...
                    B._isDate(n) && e < n ? e = n : B._isDate(i) && i < e && (e = i),
            ...
            value: function(e, t, n) {
                var i = this.options
                  , o = new Date
                  , s = B._getDaysInMonth(e, t)
                  , a = new Date(e,t,1).getDay()
                  , r = []
                  , l = [];
                B._setToStartOfDay(o),
                0 < i.firstDay && (a -= i.firstDay) < 0 && (a += 7);
                for (var u = 0 === t ? 11 : t - 1, c = 11 === t ? 0 : t + 1, h = 0 === t ? e - 1 : e, d = 11 === t ? e + 1 : e, p = B._getDaysInMonth(h, u), f = s + a, v = f; 7 < v; )
                    v -= 7;
                f += 7 - v;
                for (var m = !1, y = 0, g = 0; y < f; y++) {
                    var _ = new Date(e,t,y - a + 1)
                      , b = !!B._isDate(this.date) && B._compareDates(_, this.date)
                      , w = B._compareDates(_, o)
                      , k = -1 !== i.events.indexOf(_.toDateString())
                      , C = y < a || s + a <= y
                      , O = y - a + 1
                      , E = t
                      , M = e
                      , T = i.startRange && B._compareDates(i.startRange, _)
                      , D = i.endRange && B._compareDates(i.endRange, _)
                      , L = i.startRange && i.endRange && i.startRange < _ && _ < i.endRange;
                    C && (M = y < a ? (O = p + O,
                    E = u,
                    h) : (O -= s,
                    E = c,
                    ...
                    var x = {
                        ...
                        isSelected: b,
                        isToday: w,
                        isDisabled: i.minDate && _ < i.minDate || i.maxDate && _ > i.maxDate || i.disableWeekends && B._isWeekend(_) || i.disableDayFn && i.disableDayFn(_),
                        isEmpty: C,
                        isStartRange: T,
                        isEndRange: D,
                        isInRange: L,
                    ...
                    l.push(this.renderDay(x)),
                    7 == ++g && (r.push(this.renderRow(l, i.isRTL, m)),
                    g = 0,
                    m = !(l = []))
                }
            ...
            value: function(e, t, n, i, o, s) {
                var a, r, l = void 0, u = void 0, c = void 0, h = this.options, d = n === h.minYear, p = n === h.maxYear, f = '<div id="' + s + '" class="datepicker-controls" role="heading" aria-live="assertive">', v = !0, m = !0;
                for (c = [],
                l = 0; l < 12; l++)
                    c.push('<option value="' + (n === o ? l - t : 12 + l - t) + '"' + (l === i ? ' selected="selected"' : "") + (d && l < h.minMonth || p && l > h.maxMonth ? 'disabled="disabled"' : "") + ">" + h.i18n.months[l] + "</option>");
                for (a = '<select class="datepicker-select orig-select-month" tabindex="-1">' + c.join("") + "</select>",
                u = y.isArray(h.yearRange) ? (l = h.yearRange[0],
                h.yearRange[1] + 1) : (l = n - h.yearRange,
                1 + n + h.yearRange),
                c = []; l < u && l <= h.maxYear; l++)
                    l >= h.minYear && c.push('<option value="' + l + '" ' + (l === n ? 'selected="selected"' : "") + ">" + l + "</option>");
                r = '<select class="datepicker-select orig-select-year" tabindex="-1">' + c.join("") + "</select>";
                f += '<button class="month-prev' + (v ? "" : " is-disabled") + '" type="button"><svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"/><path d="M0-.5h24v24H0z" fill="none"/></svg></button>',
                f += '<div class="selects-container">',
                h.showMonthAfterYear ? f += r + a : f += a + r,
                f += "</div>",
                d && (0 === i || h.minMonth >= i) && (v = !1),
                p && (11 === i || h.maxMonth <= i) && (m = !1);
                return (f += '<button class="month-next' + (m ? "" : " is-disabled") + '" type="button"><svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z"/><path d="M0-.25h24v24H0z" fill="none"/></svg></button>') + "</div>"
            }
        }, {
            key: "draw",
            value: function(e) {
                if (this.isOpen || e) {
                    var t, n = this.options, i = n.minYear, o = n.maxYear, s = n.minMonth, a = n.maxMonth, r = "";
                    this._y <= i && (this._y = i,
                    ...
                    for (var l = 0; l < 1; l++)
                        this._renderDateDisplay(),
                        r += this.renderTitle(this, l, this.calendars[l].year, this.calendars[l].month, this.calendars[0].year, t) + this.render(this.calendars[l].year, this.calendars[l].month, t);
                    this.destroySelects(),
            ...
            value: function(e) {
                if (this.isOpen) {
                    var t = y(e.target);
                    t.hasClass("is-disabled") || (!t.hasClass("datepicker-day-button") || t.hasClass("is-empty") || t.parent().hasClass("is-disabled") ? t.closest(".month-prev").length ? this.prevMonth() : t.closest(".month-next").length && this.nextMonth() : (this.setDate(new Date(e.target.getAttribute("data-year"),e.target.getAttribute("data-month"),e.target.getAttribute("data-day"))),
            ...
            key: "init",
            value: function(e, t) {
                return _get(B.__proto__ || Object.getPrototypeOf(B), "init", this).call(this, this, e, t)
            }
        }, {
            key: "_isDate",
            value: function(e) {
            ...
            value: function(e) {
                B._isDate(e) && e.setHours(0, 0, 0, 0)
            }
        }, {
            key: "_getDaysInMonth",
            value: function(e, t) {
                return [31, B._isLeapYear(e) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][t]
            }
        }, {
            key: "_isLeapYear",
            value: function(e) {
    ...
    var t = {
      ...
      , e = function(e) {
        function v(e, t) {
            ...
            var n = _possibleConstructorReturn(this, (v.__proto__ || Object.getPrototypeOf(v)).call(this, v, e, t));
            return (n.el.M_Timepicker = n).options = u.extend({}, v.defaults, t),
            n.id = M.guid(),
            n._insertHTMLIntoDOM(),
            n._setupModal(),
            n._setupVariables(),
        ...
        return _inherits(v, Component),
        _createClass(v, [{
            key: "destroy",
            value: function() {
                this._removeEventHandlers(),
                this.modal.destroy(),
                u(this.modalEl).remove(),
            ...
            value: function() {
                ...
                u(this.spanHours).on("click", this.showView.bind(this, "hours")),
                u(this.spanMinutes).on("click", this.showView.bind(this, "minutes"))
            }
        }, {
            key: "_removeEventHandlers",
            value: function() {
            ...
            value: function(e) {
                ...
                this.y0 = i + this.options.dialRadius,
                this.moved = !1;
                var o = v._Pos(e);
                this.dx = o.x - this.x0,
                this.dy = o.y - this.y0,
            ...
            value: function(e) {
                ...
                var n = v._Pos(e)
                  , i = n.x - this.x0
                  , o = n.y - this.y0;
                this.moved && i === this.dx && o === this.dy && this.setHand(i, o),
                "hours" === this.currentView ? this.showView("minutes", this.options.duration / 2) : this.options.autoClose && (u(this.minutesView).addClass("timepicker-dial-out"),
                setTimeout(function() {
                    t.done()
            ...
            value: function() {
                ...
                u('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.i18n.cancel + "</button>").appendTo(t).on("click", this.close.bind(this)),
                u('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.i18n.done + "</button>").appendTo(t).on("click", this.done.bind(this)),
                t.appendTo(this.footer)
            }
        }, {
            key: "_clockSetup",
            value: function() {
                this.options.twelveHour && (this.$amBtn = u('<div class="am-btn">AM</div>'),
                this.$pmBtn = u('<div class="pm-btn">PM</div>'),
            ...
            value: function() {
                var e = this.options.dialRadius
                  ...
                  , n = 2 * e
                  , i = v._createSVGEl("svg");
                i.setAttribute("class", "timepicker-svg"),
                i.setAttribute("width", n),
                i.setAttribute("height", n);
                var o = v._createSVGEl("g");
                o.setAttribute("transform", "translate(" + e + "," + e + ")");
                var s = v._createSVGEl("circle");
                s.setAttribute("class", "timepicker-canvas-bearing"),
                s.setAttribute("cx", 0),
                s.setAttribute("cy", 0),
                s.setAttribute("r", 4);
                var a = v._createSVGEl("line");
                a.setAttribute("x1", 0),
                a.setAttribute("y1", 0);
            ...
            value: function(e) {
                var t = u(e.target);
                this.amOrPm = t.hasClass("am-btn") ? "AM" : "PM",
            ...
            value: function() {
                ...
                "now" === e[0]) {
                    ...
                    this.options.twelveHour && (this.amOrPm = 12 <= e[0] && e[0] < 24 ? "PM" : "AM")
                }
                this.hours = +e[0] || 0,
                this.minutes = +e[1] || 0,
                this.spanHours.innerHTML = this.hours,
                this.spanMinutes.innerHTML = v._addLeadingZero(this.minutes),
                this._updateAmPmView()
            }
        }, {
            key: "showView",
            value: function(e, t) {
                ...
                this.currentView = e,
                u(this.spanHours).toggleClass("text-primary", n),
                u(this.spanMinutes).toggleClass("text-primary", !n),
                o.classList.add("timepicker-dial-out"),
                u(i).css("visibility", "visible").removeClass("timepicker-dial-out"),
                this.resetClock(t),
            ...
            value: function(e) {
                var t = this.currentView
                  ...
                  , i = "hours" === t
                  , o = n * (Math.PI / (i ? 6 : 30))
                  , s = i && 0 < n && n < 13 ? this.options.innerRadius : this.options.outerRadius
                  , a = Math.sin(o) * s
                  , r = -Math.cos(o) * s
                  , l = this;
                e ? (u(this.canvas).addClass("timepicker-canvas-out"),
                setTimeout(function() {
                    u(l.canvas).removeClass("timepicker-canvas-out"),
                    l.setHand(a, r)
                }, e)) : this.setHand(a, r)
            }
        }, {
            ...
            value: function(e, t, n) {
                var i = this
                  ...
                  , a = Math.PI / (s || n ? 6 : 30)
                  , r = Math.sqrt(e * e + t * t)
                  , l = s && r < (this.options.outerRadius + this.options.innerRadius) / 2
                  , u = l ? this.options.innerRadius : this.options.outerRadius;
                this.options.twelveHour && (u = this.options.outerRadius),
                o < 0 && (o = 2 * Math.PI + o);
                var c = Math.round(o / a);
                o = c * a,
                this.options.twelveHour ? s ? 0 === c && (c = 12) : (n && (c *= 5),
                60 === c && (c = 0)) : s ? (12 === c && (c = 0),
                c = l ? 0 === c ? 12 : c : 0 === c ? 0 : c + 12) : (n && (c *= 5),
                60 === c && (c = 0)),
                ...
                s ? this.spanHours.innerHTML = c : this.spanMinutes.innerHTML = v._addLeadingZero(c);
                var h = Math.sin(o) * (u - this.options.tickRadius)
                  , d = -Math.cos(o) * (u - this.options.tickRadius)
                  , p = Math.sin(o) * u
                  , f = -Math.cos(o) * u;
                this.hand.setAttribute("x2", h),
                this.hand.setAttribute("y2", d),
            ...
            value: function(e, t) {
                var n = this.el.value
                  , i = t ? "" : v._addLeadingZero(this.hours) + ":" + v._addLeadingZero(this.minutes);
                this.time = i,
                !t && this.options.twelveHour && (i = i + " " + this.amOrPm),
                (this.el.value = i) !== n && this.$el.trigger("change"),
                this.close(),
                this.el.focus()
            }
        }, {
...
!function(o) {
    ...
    var t = {}
      , e = function(e) {
        function i(e, t) {
            _classCallCheck(this, i);
            var n = _possibleConstructorReturn(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, i, e, t));
            return (n.el.M_CharacterCounter = n).options = o.extend({}, i.defaults, t),
            n.isInvalid = !1,
            n.isValidLength = !1,
            n._setupCounter(),
            n._setupEventHandlers(),
        ...
        _createClass(i, [{
            ...
            value: function() {
                ...
                o(this.counterEl).addClass("character-counter").css({
                    float: "right",
                    "font-size": "12px",
                    height: 1
                }),
    ...
    M.jQueryLoaded && M.initializeJqueryWrapper(e, "characterCounter", "M_CharacterCounter")
}(cash);
_createClass = function() {
    function i(e, t) {
        for (var n = 0; n < t.length; n++) {
...
!function(c) {
    ...
    var t = {
      ...
      , e = function(e) {
        function i(e, t) {
            _classCallCheck(this, i);
            var n = _possibleConstructorReturn(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, i, e, t));
            return n.$el.hasClass("browser-default") ? _possibleConstructorReturn(n) : ((n.el.M_FormSelect = n).options = c.extend({}, i.defaults, t),
        ...
        _createClass(i, [{
            ...
            value: function(e) {
                ...
                var t = c(e.target).closest("li")[0]
                  , n = t.id;
                if (!c(t).hasClass("disabled") && !c(t).hasClass("optgroup") && n.length) {
                    var i = !0;
                    if (this.isMultiple) {
                        var o = c(this.dropdownOptions).find("li.disabled.selected");
                        o.length && (o.removeClass("selected"),
                        o.find('input[type="checkbox"]').prop("checked", !1),
                        this._toggleEntryFromArray(o[0].id)),
                        i = this._toggleEntryFromArray(n)
                    } else
                        c(this.dropdownOptions).find("li").removeClass("selected"),
                        c(t).toggleClass("selected", i),
                        this._keysSelected = {},
                        this._keysSelected[t.id] = !0;
                    c(this._valueDict[n].el).prop("selected") !== i && (c(this._valueDict[n].el).prop("selected", i),
                    this.$el.trigger("change"))
                }
                e.stopPropagation()
            }
            ...
            value: function() {
                ...
                c(this.wrapper).addClass("select-wrapper " + this.options.classes),
                this.$el.before(c(this.wrapper)),
                this.wrapper.appendChild(this.el),
                this.el.disabled && this.wrapper.classList.add("disabled"),
                this.$selectOptions = this.$el.children("option, optgroup"),
                this.dropdownOptions = document.createElement("ul"),
                this.dropdownOptions.id = "select-options-" + M.guid(),
                c(this.dropdownOptions).addClass("dropdown-content select-dropdown " + (this.isMultiple ? "multiple-select-dropdown" : "")),
                this.$selectOptions.length && this.$selectOptions.each(function(e) {
                    if (c(e).is("option")) {
                        var t = void 0;
                        t = i.isMultiple ? i._appendOptionWithIcon(i.$el, e, "multiple") : i._appendOptionWithIcon(i.$el, e),
                        i._addOptionToValueDict(e, t)
                    } else if (c(e).is("optgroup")) {
                        var n = c(e).children("option");
                        c(i.dropdownOptions).append(c('<li class="optgroup"><span>' + e.getAttribute("label") + "</span></li>")[0]),
                        n.each(function(e) {
                ...
                c(this.input).addClass("select-dropdown dropdown-trigger"),
                this.input.setAttribute("type", "text"),
                this.input.setAttribute("readonly", "true"),
                this.input.setAttribute("data-target", this.dropdownOptions.id),
                this.el.disabled && c(this.input).prop("disabled", "true"),
                ...
                if (this.$el.before(e[0]),
                !this.el.disabled) {
                    var t = c.extend({}, this.options.dropdownOptions);
                    t.onOpenEnd = function(e) {
                        var t = c(i.dropdownOptions).find(".selected").first();
                        if (t.length && (M.keyDown = !0,
                        i.dropdown.focusedIndex = t.index(),
                        i.dropdown._focusFocusedItem(),
                        M.keyDown = !1,
                        i.dropdown.isScrollable)) {
                            var n = t[0].getBoundingClientRect().top - i.dropdownOptions.getBoundingClientRect().top;
                            n -= i.dropdownOptions.clientHeight / 2,
                            i.dropdownOptions.scrollTop = n
                        }
                    }
                    ,
            ...
            key: "_removeDropdown",
            value: function() {
                c(this.wrapper).find(".caret").remove(),
                c(this.input).remove(),
                c(this.dropdownOptions).remove(),
                c(this.wrapper).before(this.$el),
            ...
            value: function(e, t, n) {
                var i = t.disabled ? "disabled " : ""
                  ...
                  , s = this.isMultiple ? '<label><input type="checkbox"' + i + '"/><span>' + t.innerHTML + "</span></label>" : t.innerHTML
                  , a = c("<li></li>")
                  , r = c("<span></span>");
                r.html(s),
                a.addClass(i + " " + o),
                ...
                if (l) {
                    var u = c('<img alt="" src="' + l + '">');
                    a.prepend(u)
                }
                return c(this.dropdownOptions).append(a[0]),
                a[0]
            }
        }, {
            ...
            value: function(e) {
                var t = !this._keysSelected.hasOwnProperty(e)
                  , n = c(this._valueDict[e].optionEl);
                return t ? this._keysSelected[e] = !0 : delete this._keysSelected[e],
                n.toggleClass("selected", t),
                n.find('input[type="checkbox"]').prop("checked", t),
                n.prop("selected", t),
                t
            }
        }, {
            ...
            value: function() {
                ...
                this._valueDict) {
                    var t = this._valueDict[e]
                      , n = c(t.el).prop("selected");
                    c(t.optionEl).find('input[type="checkbox"]').prop("checked", n),
                    n ? (this._activateOption(c(this.dropdownOptions), c(t.optionEl)),
                    this._keysSelected[e] = !0) : c(t.optionEl).removeClass("selected")
                }
            }
        }, {
            key: "_activateOption",
            value: function(e, t) {
                t && (this.isMultiple || e.find("li.selected").removeClass("selected"),
    ...
    M.FormSelect = e,
    M.jQueryLoaded && M.initializeJqueryWrapper(e, "formSelect", "M_FormSelect")
}(cash);
_createClass = function() {
    function i(e, t) {
        for (var n = 0; n < t.length; n++) {
...
!function(o, t) {
    ...
    var n = {}
      , e = function(e) {
        function i(e, t) {
            _classCallCheck(this, i);
            var n = _possibleConstructorReturn(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, i, e, t));
            return (n.el.M_Range = n).options = o.extend({}, i.defaults, t),
            n._mousedown = !1,
            n._setupThumb(),
            n._setupEventHandlers(),
            n
        ...
        _createClass(i, [{
            ...
            value: function(e) {
                if (o(this.value).html(this.$el.val()),
                this._mousedown = !0,
                this.$el.addClass("active"),
                o(this.thumb).hasClass("active") || this._showRangeBubble(),
                "input" !== e.type) {
            ...
            value: function() {
                if (!this._mousedown) {
                    ...
                    o(this.thumb).hasClass("active") && (t.remove(this.thumb),
                    t({
                        targets: this.thumb,
                        height: 0,
                        width: 0,
            ...
            value: function() {
                ...
                o(this.thumb).addClass("thumb"),
                o(this.value).addClass("value"),
                o(this.thumb).append(this.value),
    ...
    e.init(o("input[type=range]"))
}(cash, M.anime);
//# sourceMappingURL=materialize.min.js.map

jQuery(document).ready(function($) {
    $(".sidenav.open-right").sidenav({
        edge: "right",
        dragable: !0,
        preventScrolling: !0
    }),
    $(".sidenav.open-left").sidenav({
        edge: "left",
        dragable: !0,
        preventScrolling: !1
    }),
    ...
    $(".multiple-select .dropdown-trigger").dropdown({
        closeOnClick: !1,
        constrainWidth: !1,
        coverTrigger: !1,
        alignment: "left"
...
jQuery.fn.exists = function(t) {
    ...
    return this.length && t.call(this, e),
    this
}
,
jQuery(".sticky-navbar").exists(function($) {
    var t = $(".sticky-navbar").offset().top
      , e = $(".sticky-navbar").height();
    jQuery(window).on("scroll", function($) {
        $(window).scrollTop() > t ? ($(".sticky-navbar").addClass("menu-fixed"),
        $("body").css("padding-top", e),
        $(".mini-logo").addClass("show")) : ($(".sticky-navbar").removeClass("menu-fixed"),
...
jQuery(document).ready(function($) {
    $(window).scroll(function() {
        var t = 1.5 * $(window).height();
        $(this).scrollTop() > t ? $("#back-to-top").fadeIn() : $("#back-to-top").fadeOut()
    }),
...
jQuery('a[href*="#"]').not('[href="#"]').not('[href="#0"]').not('[data-toggle="collapse"]').not('[data-toggle="tab"]').click(function(t) {
...
jQuery(window).on("load resize", function($) {
    jQuery(".last-child-no-border li.no-border").prev().removeClass("no-border"),
    jQuery(".last-child-no-border li.flex-item").not(":hidden").last().addClass("no-border")
});
jQuery(document).ready(function () { 
     jQuery(document).on('click', '#mobileNavBtn', function() { console.log('page is loaded' , jQuery(".sidenav-btn").class);
        jQuery("#mobileBtn").addClass("toggle-active");
        // "block" === jQuery(".sidenav-overlay").css("display") && jQuery(".sidenav-btn").removeClass("toggle-active")
      });
    // jQuery("#mobileBtn").on('click',function($) { console.log('clicked')
    //     $(".sidenav-btn").toggleClass("toggle-active"),
    //     "block" === $(".sidenav-overlay").css("display") && $(".sidenav-btn").removeClass("toggle-active")
    // });

    //jQuery(document).ready(function() {
           if (jQuery('body').hasClass("single-property")) {
                //alert("hi");
                jQuery('body').addClass("property-detail");
           }
    //    });
}),

jQuery(".swipe-tabs").swipe({
    swipeLeft: function() {
        jQuery(".nav-tabs li.active").next("li").find("a").tab("show")
    },
    swipeRight: function() {
        jQuery(".nav-tabs li.active").prev("li").find("a").tab("show")
    }
}); 

//console.log(jQuery("#mobileBtn"), jQuery('body'));

jQuery("#mobileBtn").trigger('click')
var button = jQuery(".btn-share-social")[0]
  , el = jQuery(".share-social")[0];
function toggleCollapsing(t) {
    t.matches ? (jQuery(".filter-title > div").attr("aria-expanded", "true").removeClass("collapsed"),
    jQuery("ul.collapse").attr("aria-expanded", "true").addClass("in").css("height", "auto")) : (jQuery(".filter-title > div").attr("aria-expanded", "false").addClass("collapsed"),
    jQuery("ul.collapse").attr("aria-expanded", "false").removeClass("in"))
}
jQuery(button).on("click", function(t) {
    $(el).toggleClass("active"),
    t.stopPropagation()
}),
jQuery(document).on("click", function(t) {
    0 === jQuery(t.target).closest(el).length && jQuery(el).removeClass("active")
}),
jQuery(document).on("keydown", function(t) {
    27 === t.keyCode && jQuery(el).removeClass("active")
}),
jQuery(el).on("click", function(t) {
    jQuery(el).removeClass("active"),
    t.stopPropagation()
});
var mediaQ = window.matchMedia("(min-width: 480px)");
toggleCollapsing(mediaQ),
mediaQ.addListener(toggleCollapsing),
jQuery(window).on("load resize", function() {
    jQuery(".search-col.one > *").not(":hidden").first().addClass("no-margin-top")
}),
jQuery(".money-format").on({
    focus: function(t) {
        jQuery(t.target).select()
    },
    focusout: function(t) {
        jQuery(t.target).val(function(t, e) {
...
jQuery(document).ready(function($) {
    $("#toggle-map").click(function() {
        ...
        $("main").toggleClass("map-active");
        $(".map-search-result").toggleClass("show-map");
        $(".listing-search-result").toggleClass("col-sm-6 col-lg-7");
    })
}),
function(i) {
    function t() {
        var t = i(".map-search-results").width()
          , e = i(window).height()
          , a = i(".searching-navbar").height() + 30
          , o = e - a + 30;
        window.matchMedia("(max-width: 479px)").matches && i("#toggle-map").hasClass("active") ? (i("#toggle-map").toggleClass("active"),
        i('#toggle-map').toggleClass('active'),
        i("main").toggleClass("map-active"),
        i(".map-search-result").toggleClass("show-map"),
        i(".listing-search-result").toggleClass("col-sm-6 col-lg-4"),
        i(".map-wrap").height(0)) : window.matchMedia("(min-width: 768px)").matches ? i(".map-wrap").height(e - a).width(t) : i(".map-wrap").height(o).width(t)
    }
    t(),

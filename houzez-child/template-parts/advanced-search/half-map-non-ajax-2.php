                ...
                <div class="row">
                    <div class="col-xxs-12">
                        ...
                        <div class="main-search-inputs flex-container">
                                        ...
                                        <div class="form-group for-rent-living status-select" style="display: none;">
                                            <select class="selectpicker1 status-right1" name="status" data-live-search="false" data-live-search-style="begins">
                                                ...
                                                foreach ($prop_status as $term) {
                                                    $selected = urldecode($term->slug) == 'for-rent-living' ? 'selected="selected"' : '';
                            ...
                            <div>
                                <a href="#advanced-search-menu2" role="button" id="rent_toggle_id" class="bd-black waves-effect waves-color-1 collapsed" data-toggle="collapse" aria-expanded="false">

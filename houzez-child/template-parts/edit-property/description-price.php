    ...
    <div class="add-tab-content">
        ...
        <div class="add-tab-row push-padding-bottom">
            <div class="row">
                ...
                <?php 
                    $taxonomy_terms = get_terms( 'property_status', array(
                                            'hide_empty' => false,
                                        ) );
                        if( !empty($taxonomy_terms) ){
                            foreach( $taxonomy_terms as $term ){
                                echo "<div class='row'>";
                                if( $hide_add_prop_fields['sale_rent_price'] != 1 ) { 
                             ?>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="prop_price"> <?php echo $term->name . " Price " .houzez_required_field( $required_fields['sale_rent_price'] );

                        ...
                        <div class="header-left">
                            ...
                            <div class="gallery_directory">
                                <ul>
                                    ...
                                    <?php if($prop_video_url !=""){ ?>
                                        <li class="custom_media"><a id="video" alt="<?php the_title(); ?> Video" href="javascript:void(0)">Video</a></li>
                                    <?php } ?>

                                    <?php if($virtual_tour !=""){ ?>
                                        <li class="custom_media"><a id="360" alt="<?php the_title(); ?> 360 Tours" href="javascript:void(0)">360</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
